...
import makeTooltip from "./widget-tooltip.js";
import mapboxgl, { modifyMapboxElements } from "./utils/mapbox-utils.js";
import { loadScript } from "./utils/script-utils.js";
import { createGoogleMapsDeckOverlay } from "./utils/google-maps-utils.js";
import { addSupportComponents } from "../lib/components/index.js";
/* eslint-disable import/namespace */
import * as deckExports from "../deck-bundle.js";
...
function createStandaloneFromProvider({ mapProvider, props, mapboxApiKey, googleMapsKey, handleEvent, getTooltip, container }) {
...
function createDeck({ mapboxApiKey, googleMapsKey, container, jsonInput, tooltip, handleEvent, customLibraries, configuration }) {
    let deckgl;
    try {
        if (configuration) {
